...
public class MainActivity extends AppCompatActivity implements AddCommentFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myScannedCodes.setText(myAccount.stats.getTotalQRCodesScanned().toString());
        myQRScore.setText(myAccount.stats.getSumOfScoresScanned().toString());
        myRank.setText(myAccount.stats.getRank().toString());
